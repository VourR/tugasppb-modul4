  ...
  return (
    <section>
      <h1 className="text-3xl md:text-5xl font-bold text-slate-800 text-center mb-4">
        {title ?? 'Jelajahi Resep Makanan'}
      </h1>
      <p className="text-center text-slate-500 max-w-2xl mx-auto mb-8">
        {title ? 'Temukan resep favorit yang sudah Anda tandai.' : 'Temukan inspirasi masakan Nusantara favoritmu. Dari hidangan utama hingga camilan, semua ada di sini.'}
      </p>
